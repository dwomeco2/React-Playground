...
export default function ImageSlider() {
	...
	useEffect(() => {
		const resizeCallback = () => {
			let el = document.querySelector(".image_slide_item:nth-child(3)")
			if (el) {
				el.scrollIntoView({
					behavior: "auto",
					block: "center",
	...
	return (
		<div className='relative w-full'>
			<div className='absolute-center-xy mt-[120px] flex w-[600px] sm:w-[720px] justify-center scale-50 sm:scale-100 transition-all'>
				<TransitionGroup
							...
							>
								...
								>
									...
									>
										<SuspenseImage
											src={image.src}
											width={image_size[index]}
											height={image_size[index]}
										/>
									</Suspense>
									<img
										src={image.src}
