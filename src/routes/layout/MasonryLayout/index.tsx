...
function useAnimatedImage(imagesProp: imageType[] | null): AnimatedLayoutHookType {
  ...
  return (
    <div>
      ...
      <div className="flex gap-x-4 justify-center my-6">
        ...
        <button className="bg-red-500 rounded-full py-2 px-8 text-white" onClick={addFiveImage}>
          Add 5
        </button>
      </div>
